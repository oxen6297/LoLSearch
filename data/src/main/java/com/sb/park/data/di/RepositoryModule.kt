...
import com.sb.park.data.repository.VersionRepositoryImpl
import dagger.Binds
...
internal abstract class RepositoryModule {
    ...
    @Binds
    abstract fun provideVersionRepository(versionRepositoryImpl: VersionRepositoryImpl): VersionRepository
}